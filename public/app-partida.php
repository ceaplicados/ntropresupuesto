...
$PartidaGenerica=$DaoPartidasGenericas->getByClave($navURI[2]);
$ConceptoGeneral=$DaoConceptosGenerales->show($PartidaGenerica->getConceptoGeneral());
$CapituloGasto=$DaoCapitulosGasto->show($ConceptoGeneral->getCapituloGasto());
if(!$PartidaGenerica->getId()>0){
	header("Location: /404");
	exit();
}
...
if($reload){
	header("Location: /".$Estado->getCodigo()."/PartidasGenericas/".$PartidaGenerica->getClave()."?v=$v&i=$i");
	exit();
}
...
$title="Presupuesto para la partida genérica ".$PartidaGenerica->getClave()." - ".$PartidaGenerica->getNombre()."@ ".$Estado->getNombre();
		...
		<div class="row">
			<div class="col-md-6">
				<ol class="breadcrumb darklinks">
					...
					<li><a href="/<?php echo($Estado->getCodigo()); ?>/ConceptosGenerales/<?php echo($ConceptoGeneral->getClave()); ?>"><?php echo($ConceptoGeneral->getClave()); ?></a></li>
					<li class="active"><?php echo($PartidaGenerica->getClave()." - ".$PartidaGenerica->getNombre()); ?></li>
				</ol>
			</div>
			<!-- .col-* -->
...
<section class="ls section_padding_top_50 section_padding_bottom_50 columns_padding_10">
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-md-12">
				<h3 class="dashboard-page-title"><?php echo($PartidaGenerica->getClave()." - ".$PartidaGenerica->getNombre()); ?>
				</h3>
		...
		<div class="row">
			...
			<div class="col-xs-12 contenedorGraficas" data-graph="all">
				<div class="with_border with_padding" id="barrasCG">
					<h4>Histórico por Objeto de Gasto</h4>
		...
		<div class="row tablasCG">
			...
			<div class="col-xs-12 overflow-x" id="contenedorTablas">
				<div id="tablaConceptoGeneral" >
					<h5>Detalle histórico por Objeto de Gasto</h5>
					<table class="table">
						<thead>
							<tr class="anio">
							</tr>
				...
				<div id="tablaConceptoGeneralVariaciones">
					<h5>Variación histórica por Objeto de Gasto</h5>
					<table class="table">
						<thead>
							<tr class="anio">
							</tr>
...
<input type="hidden" id="paramPartidaGenerica" value="<?php echo($PartidaGenerica->getId()); ?>"/>
<input type="hidden" id="paramCodigoPartidaGenerica" value="<?php echo($PartidaGenerica->getClave()); ?>"/>
