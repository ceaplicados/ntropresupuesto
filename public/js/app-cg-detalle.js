$(document).ready(function(){
	...
	$.post("/backend",params,function(resp){
		...
		for (var j in resp.conceptos){
			...
			if(TotalConcepto>0){
				$('#tablaConceptoGeneral tbody').append('<tr><td>'+resp.conceptos[j].Clave+' - '+resp.conceptos[j].Nombre+' <a href="/'+$('#paramCodigoEstado').val()+'/ConceptosGenrales/'+resp.conceptos[j].Clave+'"><i class="fa fa-chevron-circle-right" aria-hidden="true"></i></a></td>'+rowAnio+'</tr>');
				$('#tablaConceptoGeneralVariaciones tbody').append('<tr><td>'+resp.conceptos[j].Clave+' - '+resp.conceptos[j].Nombre+' <a href="/'+$('#paramCodigoEstado').val()+'/ConceptosGenrales/'+resp.conceptos[j].Clave+'"><i class="fa fa-chevron-circle-right" aria-hidden="true"></i></a></td>'+rowVariaciones+'</tr>');
			}
		}
	...
	$.post("/backend",params,function(resp){
		...
		for (var j in resp.URs){
			...
			if(TotalConcepto>0){
				$('#tablaUnidadResponsable tbody').append('<tr><td>'+resp.URs[j].Clave+' - '+resp.URs[j].Nombre+' <a href="CapituloGasto/'+resp.URs[j].Clave+'"><i class="fa fa-chevron-circle-right" aria-hidden="true"></i></a></td>'+rowAnio+'</tr>');
				$('#tablaUnidadResponsableVariaciones tbody').append('<tr><td>'+resp.URs[j].Clave+' - '+resp.URs[j].Nombre+' <a href="CapituloGasto/'+resp.URs[j].Clave+'"><i class="fa fa-chevron-circle-right" aria-hidden="true"></i></a></td>'+rowVariaciones+'</tr>');
			}
		}
