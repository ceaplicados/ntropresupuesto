...
if($reload){
	header("Location: /".$Estado->getCodigo()."/CapituloGasto?v=$v&i=$i");
	exit();
}
...
$title="Presupuesto por capítulos de gasto @ ".$Estado->getNombre();
		...
		<div class="row">
			<div class="col-md-6">
				<ol class="breadcrumb darklinks">
					...
					<li class="active">Capítulos de gasto</li>
				</ol>
			</div>
			<!-- .col-* -->
...
<section class="ls section_padding_top_50 section_padding_bottom_50 columns_padding_10">
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-md-12">
				<h3 class="dashboard-page-title">Capítulos de gasto
				</h3>
		...
		<div class="row">
			...
			<div class="col-xs-12" id="contenedorGraficas" data-graph="all">
				...
				<div class="with_border with_padding" id="areasCG">
					<h4>Distribución porcentual histórica de los capítulos de gasto</h4>
					<div class="canvas-chart-wrapper">
						<canvas class="chart-area-historico-ur"></canvas>
					</div>
				</div>
				<div class="with_border with_padding" id="variacionCG">
					<h4>Variación de los capítulos de gasto</h4>
					<div class="canvas-chart-wrapper">
						<canvas class="chart-variacion-cg"></canvas>
					</div>
				</div>
				<div class="col-xs-12 text-right tiposGrafica">
					<button title="Histórico por Capítulo de Gasto" onclick="showGraph(this)" class="button" data-target="barrasCG" data-tabla="tablaHistorico"><i class="fa fa-bar-chart" aria-hidden="true"></i></button>
					<button title="Distribución histórica de los capítulos de gasto" onclick="showGraph(this)" class="button" data-target="areasCG" data-tabla="tablaDistribucionHistorica"><i class="fa-solid fa-chart-area"></i></button>
					<button title="Variación de los capítulos de gasto" onclick="showGraph(this)" class="button" data-target="variacionCG"  data-tabla="tablaVariaciones"><i class="fa fa-line-chart" aria-hidden="true"></i></button>
				</div>
			</div>
			<!-- .col-* -->
		</div>
		<div class="row" id="contenedorTablas">
			<div class="col-xs-12 overflow-x">
				...
				<table id="tablaDistribucionHistorica" class="table">
					<thead>
						<tr class="anio">
						</tr>
					</thead>
				...
				<table id="tablaVariaciones" class="table">
					<thead>
						<tr class="anio">
						</tr>
					</thead>
