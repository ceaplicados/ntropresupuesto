...
$CapituloGasto=$DaoCapitulosGasto->getByClave($navURI[2]);
if(!$CapituloGasto->getId()>0){
	header("Location: /404");
	exit();
}
...
if($reload){
	header("Location: /".$Estado->getCodigo()."/CapituloGasto/".$CapituloGasto->getClave()."?v=$v&i=$i");
	exit();
}
...
$title="Presupuesto para el capítulo de gasto ".$CapituloGasto->getClave()." - ".$CapituloGasto->getNombre()."@ ".$Estado->getNombre();
		...
		<div class="row">
			<div class="col-md-6">
				<ol class="breadcrumb darklinks">
					...
					<li class="active"><?php echo($CapituloGasto->getClave()." - ".$CapituloGasto->getNombre()); ?></li>
				</ol>
			</div>
			<!-- .col-* -->
...
<section class="ls section_padding_top_50 section_padding_bottom_50 columns_padding_10">
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-md-12">
				<h3 class="dashboard-page-title"><?php echo($CapituloGasto->getClave()." - ".$CapituloGasto->getNombre()); ?>
				</h3>
		...
		<div class="row">
			...
			<div class="col-xs-12 contenedorGraficas" data-graph="all">
				<div class="with_border with_padding" id="barrasCG">
					<h4>Histórico por Concepto General</h4>
		...
		<div class="row tablasCG">
			...
			<div class="col-xs-12 overflow-x" id="contenedorTablas">
				<div id="tablaConceptoGeneral" >
					<h5>Detalle histórico por Concepto general</h5>
					<table class="table">
						<thead>
							<tr class="anio">
							</tr>
				...
				<div id="tablaConceptoGeneralVariaciones">
					<h5>Variación histórica por Concepto general</h5>
					<table class="table">
						<thead>
							<tr class="anio">
							</tr>
...
<input type="hidden" id="paramCapituloGasto" value="<?php echo($CapituloGasto->getId()); ?>"/>
<input type="hidden" id="paramCodigoCapituloGasto" value="<?php echo($CapituloGasto->getClave()); ?>"/>
